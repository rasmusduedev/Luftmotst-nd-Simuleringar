...
@ti.func
def rusanov_flux(Axis, gamma, Left_state: ti.math.vec4, Right_state: ti.math.vec4):
    ...
    if Axis == 0: # flux for x terms
        flux_rho   = rho_star * u_star
        flux_mom_u = rho_star * u_star**2 + P_star
    ...
    elif Axis == 1: # flux for y terms
        flux_rho   = rho_star * w_star
        flux_mom_u = rho_star * u_star * w_star 
        flux_mom_w = rho_star * w_star**2 + P_star
